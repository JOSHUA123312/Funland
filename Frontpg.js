class Front{
    ...
    display(){
      ...
      this.storyButton.style('height','30px')
        ...
        this.greeting.html("Hello Player , there are 6 games.Your aim is to play and win all the games")
        this.greeting.position(displayWidth/2 - 380, displayHeight/4);
        this.first.position(displayWidth/2 -300, displayHeight/2-20);
        this.second.position(displayWidth/2 -200, displayHeight/2-20);
        this.third.position(displayWidth/2 -100, displayHeight/2-20);     
        this.fourth.position(displayWidth/2 , displayHeight/2-20);
        this.fifth.position(displayWidth/2 +100, displayHeight/2-20);     
        this.sixth.position(displayWidth/2 +200, displayHeight/2-20);
        ...
        this.fifth.style('background','orange')
        this.sixth.style('background','orange')
